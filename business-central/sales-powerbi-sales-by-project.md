...
ms.search.form: 37006_Primary   NEED PAGE ID
ms.date: 10/26/2024
...
The **Sales by Project** report provides an overview of sales performance for each project. It showcases key metrics such as total sales amount and quantity.  
...
This report helps management and sales teams track the sales amounts that each project generates and their contribution to the overall revenue.
{Placeholder for report use section}
...
Try the report here: [Sales by Project](https://businesscentral.dynamics.com?page=37006)        NEED TO UPDATE PAGE ID
