...
|Analyze item categorization by ABC based on their contribution to the total sales amount. | [ABC Analysis](https://businesscentral.dynamics.com?page=37111) | [About ABC Analysis](inventory-powerbi-abc-analysis.md)|
